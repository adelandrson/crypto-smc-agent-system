...
function _drawBoxes() {
  ...
  if (_ind.ob) (d.order_blocks || []).forEach(o => { if (!_obShow(o)) return; const b = o.type === "bull", fresh = o.status !== "mitigated"; box(o.from, o.top, o.bottom, b ? (fresh ? "rgba(66,165,245,.14)" : "rgba(66,165,245,.05)") : (fresh ? "rgba(255,167,38,.14)" : "rgba(255,167,38,.05)"), b ? "rgba(66,165,245,.6)" : "rgba(255,167,38,.6)", (o.akum ? (b ? "AKUM ⌂ support" : "DIST ⌂ resist") : (b ? "OB↑ demand" : "OB↓ supply")) + (o.flip ? " ⇄flip" : "")); });
}
